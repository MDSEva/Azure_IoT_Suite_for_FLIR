...
namespace Microsoft.Azure.Devices.Applications.RemoteMonitoring.UnitTests.Infrastructure
{
    public class DeviceTelemetryRepositoryTest
    {
        ...
        public async void LoadLatestDeviceTelemetrySummaryAsyncTest()
        {
            ...
            var blobReader = new Mock<IBlobStorageReader>();
            //MDS bae 2017.0707 telemetry temperature summary
            var blobData = "deviceid,averagetemperature,minimumtemperature,maxtemperature,timeframeminutes" + Environment.NewLine +
            ...
            Assert.Equal(telemetrySummaryList.AverageTemperature, 37.806204872115607);//MDS bae 2017.0707 telemetry temperature summary
            Assert.Equal(telemetrySummaryList.MinimumTemperature, 37.806204872115607);//MDS bae 2017.0707 telemetry temperature summary
            Assert.Equal(telemetrySummaryList.MaximumTemperature, 37.806204872115607);//MDS bae 2017.0707 telemetry temperature summary
